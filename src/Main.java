...
// make three sets of words to choose from. Add your own!
        String[] wordListOne = {"24/7", "multi-tier", "30,000 foot", "B-to-B", "win-win", "pervasive", "smart",
        ...
        String[] wordListThree = {"process", "tripping point", "solution", "architecture", "core competency",
